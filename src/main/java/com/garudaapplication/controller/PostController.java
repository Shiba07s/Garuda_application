...
import com.garudaapplication.config.AppConstants;
...
public class PostController {
	...
	// get by user
		...
		public ResponseEntity<ApiResponse>deletePost(@PathVariable Integer postId){
			...
			return new ResponseEntity<ApiResponse>(new ApiResponse("post is succesfully deleted !!",true,HttpStatus.NOT_FOUND),HttpStatus.OK) ;
