...
import com.garudaapplication.services.CategoryService;
...
public class CategoryController {
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Integer catId) {
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("category is deleted successfully !!", true,HttpStatus.NOT_FOUND),
				HttpStatus.OK);
	}
	// get
